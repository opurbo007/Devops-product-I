...
// Same contract as order/inventory/shipping: validates the INTERNAL JWT
// minted by the api-gateway (different secret than customer access tokens,
// issuer + audience pinned). All traffic must come through the gateway.
...
// RBAC: refunds move real money — admin-only.
