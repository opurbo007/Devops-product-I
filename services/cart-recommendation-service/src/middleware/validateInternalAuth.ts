...
// Same contract as the other services: validates the INTERNAL JWT minted by
// the api-gateway (different secret than customer access tokens, issuer +
// audience pinned). All traffic must come through the gateway — previously
// these cart routes were unauthenticated.
