...
wt new-tab -d "%ROOT%api-gateway" --title "api-gateway :8081" %SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe -NoExit -NoProfile -Command npm run dev ";" new-tab -d "%ROOT%services\order-service" --title "order-service :3000" %SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe -NoExit -NoProfile -Command npm run dev ";" new-tab -d "%ROOT%services\inventory-service" --title "inventory-service :3001" %SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe -NoExit -NoProfile -Command npm run dev ";" new-tab -d "%ROOT%services\shipping-service" --title "shipping-service :3002" %SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe -NoExit -NoProfile -Command npm run dev ";" new-tab -d "%ROOT%services\payment-service" --title "payment-service :3003" %SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe -NoExit -NoProfile -Command npm run dev ";" new-tab -d "%ROOT%services\notification-service" --title "notification-service :3004" %SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe -NoExit -NoProfile -Command npm run dev ";" new-tab -d "%ROOT%services\cart-recommendation-service" --title "cart-service :3005" %SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe -NoExit -NoProfile -Command npm run dev ";" new-tab -d "%ROOT%frontend\storefront" --title "storefront :3006" %SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe -NoExit -NoProfile -Command npm run dev -- --port 3006 ";" new-tab -d "%ROOT%frontend\admin-dashboard" --title "admin-dashboard :3007" %SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe -NoExit -NoProfile -Command npm run dev -- --port 3007
